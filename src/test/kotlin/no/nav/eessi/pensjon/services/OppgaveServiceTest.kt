...
internal class OppgaveServiceTest {
    ...
    fun `BehandleSedBeskrivelse for behandling av vedlegg som ikke støttes`() {
        val oppgaveMelding = OppgaveMelding(null, P11000, null, "", null, "BEHANDLE_SED", "654654321", HendelseType.MOTTATT, "bogus.doc")
        val expected = """
    ...
    fun `BehandleSedBeskrivelse for behandling av kravSED P2200 for autojournalføring`() {
        val oppgaveMelding = OppgaveMelding(null, P2200, "654616", "", "1234567891234", "BEHANDLE_SED", "654654321", HendelseType.MOTTATT, null)
        val expected = """
    ...
    fun `BehandleSedBeskrivelse for behandling av kravSED P2200 for autojournalføring filnavn er tomstreng`() {
        val oppgaveMelding = OppgaveMelding(null, P2200, "654616", "", "1234567891234", "BEHANDLE_SED", "654654321", HendelseType.MOTTATT, "")
        val expected = """
            Det er mottatt P2200 - Krav om uførepensjon, med tilhørende RINA sakId: 654654321
        """.trimIndent()
    ...
    fun `BehandleSedBeskrivelse for behandling av kravSED P2000 for autojournalføring filnavn er tomstreng`() {
        val oppgaveMelding = OppgaveMelding(null, P2000, "654616", "", "1234567891234", "BEHANDLE_SED", "654654321", HendelseType.MOTTATT, "")
        val expected = """
    ...
    fun `BehandleSedBeskrivelse for behandling av P5000 for autojournalføring`() {
        val oppgaveMelding = OppgaveMelding(null, P5000, "654616", "", "1234567891234", "BEHANDLE_SED", "654654321", HendelseType.MOTTATT, null)
        val expected = """
    ...
    fun `BehandleSedBeskrivelse for behandling av P6000 for autojournalføring`() {
        val oppgaveMelding = OppgaveMelding(null, P6000, "654616", "", "1234567891234", "BEHANDLE_SED", "654654321", HendelseType.MOTTATT, null)
        val expected = """
    ...
    fun `BehandleSedBeskrivelse for behandling av SED der vi får en Runtime Exception når ingen parametre treffer`() {
        val oppgaveMelding = OppgaveMelding(null, P11000, null, "", null, "BEHANDLE_SED", "", HendelseType.MOTTATT, null)
    ...
    fun `BehandleSedBeskrivelse returnerer tom streng dersom oppgavetype ikke er BEHANDLE_SED` () {
        assertEquals("", oppgaveservice.behandleSedBeskrivelse(OppgaveMelding(null, P11000, null, "", null, "JOURNALFORING", "", HendelseType.MOTTATT, null)))
    }
